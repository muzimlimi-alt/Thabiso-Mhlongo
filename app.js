                ...
                (err, bookings) => {
                    ...
                    if (bookings) {
                        for (const b of bookings) {
                            ...
                            const bufferedEnd = addMinutesToTime(bEnd, bookingConfig.minGapMins);
...
app.post('/api/admin/bookings/:id/advancing/run-of-show', requireAdmin, async (req, res) => {
    try {
...
app.put('/api/admin/bookings/:id/advancing/run-of-show/reorder', requireAdmin, async (req, res) => {
...
app.post('/api/admin/bookings/:id/advancing/contacts', requireAdmin, async (req, res) => {
    try {
...
app.get('/api/admin/bookings/:id/advancing/download', requireAdmin, async (req, res) => {
    try {
...
app.post('/api/admin/bookings/:id/advancing/confirm', requireAdmin, async (req, res) => {
    try {
        const pack = await dbGet("SELECT id FROM advancing_packs WHERE booking_id = ?", [req.params.id]);
...
// Phase 5 (HOUSEKEEPING-NOTES.md): bannerUpload/validateBannerImageBuffer/saveBannerImage/
// BANNER_CATEGORIES/BANNER_MIN_WIDTH/BANNER_MAX_WIDTH/BANNER_MAX_BYTES/setBannerStatus — all
// single-consumer for the /api/admin/banners routes — moved into routes/admin/banners.js.
