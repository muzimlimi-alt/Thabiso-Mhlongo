...
const {
    ...
    getDateHoldsForAvailabilityCheck, getUpcomingStandaloneEventOnDate
} = require('../database/repositories/calendar.repository');

// Phase 5 (HOUSEKEEPING-NOTES.md): checkDateAvailability joined this module later, once its own
// callers (book-again, the bookings PATCH .../date route) needed relocating — it's the local-only
// (no Google API) sibling of hasCalendarConflict, and every one of its own dependencies was already
// either here or an existing Phase 4 repository export.
